...
import { VALID_GEMINI_MODELS, getDisplayString, isAutoModel, } from '@google/gemini-cli-core';
...
const ModelUsageTable = ({ models, quotas, cacheEfficiency, totalCachedTokens, currentModel, pooledRemaining, pooledLimit, pooledResetTime, }) => {
